...
public class ViewAddEditSelectPanel extends JPanel {

	public ViewAddEditSelectPanel(Controller controller){
		...
		JLabel lblChoose = new JLabel("Teacher Mode");
		...
		JButton btnNewButton_1 = new JButton("Delete Question");
		btnNewButton_1.setActionCommand("Edit Question");
		...
		btnNewButtoni.setActionCommand("BackToTeacherModePanel");
